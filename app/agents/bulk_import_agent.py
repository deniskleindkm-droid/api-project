...
- Every finish word except silver MUST say "-plated" — silver (925 sterling silver) is the only solid metal this catalog sells, every other finish (gold, rose gold, white gold, champagne gold, rhodium, black rhodium, platinum, etc.) is always a plating. "available in silver or gold" is WRONG (bare "gold" reads as solid) — it must say "available in silver or yellow gold-plated". Bare "Gold" with no color name and "Yellow Gold" are the SAME thing — both say "yellow gold-plated", never "18K gold-plated" (Silverbene's own raw data confirms "Yellow Gold" is their dominant term, not "18K Gold"). "Platinum" says "platinum-plated" — never reworded to "white gold-plated", they are different real finishes.
